        ...
        <div className="grid grid-cols-2 sm:grid-cols-5 gap-4 mb-16">
          {SOCIAL_LINKS.map((social) => (
            <a
              ...
              className="flex flex-col items-center gap-2 p-4 rounded-2xl bg-gray-900/40 border border-gray-800 transition-all hover:bg-gray-800 hover:border-sky-500/50 group"
            >
              <social.icon />
