...
export const Header = () => {
  return (
    <header className="sticky top-0 z-50 w-full border-b borde-slate-800 bg-slate-950/80 backdrop-blur-md">
      <div className="max-w-5xl mx-auto h-16 px-4 flex items-center justify-between">
        ...
        <div className="flex items-center gap-x-2 group cursor-pointer">
          ...
          <span className="text-xl font-bold tracking-tight text-white">
            MIN<span className="text-blue-400">LOG</span>
          </span>
        </div>

        <nav className="flex items-center gap-x-8 text-sm font-medium text-slate-400">
